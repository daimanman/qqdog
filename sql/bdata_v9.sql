...
CREATE TABLE `qsession_info`  (
  ...
  `msg` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `quser_info`  (
  ...
  `signature` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`id`) USING BTREE
